...
export function MaklerHero() {
  ...
  return (
    <section
      className="relative pt-32 lg:pt-40 pb-24 px-6 overflow-hidden bg-white/90"
      aria-label="SEO für Immobilienmakler – Hero"
    >
      {/* Background Image */}
      <div className="absolute inset-0 -z-20">
        <Image
          src="/images/hero_immobilienmakler_bg.png"
          alt="Modernes Architektur- und Immobilien-Hintergrundbild"
          fill
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-xl text-slate-700 font-medium leading-relaxed max-w-xl mb-10">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer noopener"
                className="inline-flex items-center justify-center gap-2 rounded-full px-8 h-14 text-lg font-semibold border border-slate-200 bg-white/50 backdrop-blur-sm text-slate-700 hover:border-accent hover:text-accent transition-[border-color,color]"
              >
          ...
          <div className="relative">
            <div className="bg-white/80 backdrop-blur-xl rounded-[3rem] p-8 border border-white/50 shadow-2xl">
              ...
              <ul className="space-y-6">
                {checklist.map((item, i) => (
                  <li key={i} className="flex items-start gap-4">
                    <div
                      className="w-8 h-8 rounded-full bg-accent/10 text-accent flex items-center justify-center shrink-0 mt-0.5"
                      aria-hidden="true"
                    >
                    ...
                    <span className="text-slate-800 text-lg leading-snug">{item}</span>
                  </li>
                ))}
              </ul>
            </div>
