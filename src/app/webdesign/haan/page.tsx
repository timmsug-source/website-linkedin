...
const features = [
    ...
    { icon: Search, title: "SEO-optimiert", desc: "Von Anfang an für Google optimiert. Top-Rankings in Haan und Umgebung." },
...
export default function WebdesignHaan() {
    return (
            ...
            >
                <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left">
                    <span className="text-sm font-medium opacity-90 inline-flex items-center gap-2">
                        ...
                        Webdesign für Unternehmen in Haan & Umgebung
                    </span>
                    ...
                    <div className="grid lg:grid-cols-[1.2fr,0.8fr] gap-12 lg:gap-20 items-center">
                        ...
                        >
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 backdrop-blur-sm text-slate-300 text-sm font-bold mb-8 border border-white/10">
                                <MapPin size={14} className="text-accent" /> Webdesign Haan
                            </div>

                            <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-extrabold text-white leading-[1.05] mb-8 tracking-tight">
                                Professionelles <span className="text-accent">Webdesign</span> für Haan.
                            </h1>

                            <p className="text-xl text-slate-400 leading-relaxed mb-10 max-w-xl font-medium">
                                Ich entwickle für Unternehmen in Haan und Umgebung hochperformante Websites, die bei Google gefunden werden und aus Besuchern echte Kunden machen – mit 5 Jahren Erfahrung und Fokus auf die KI-Zukunft.
                            </p>
                        ...
                        >
                            ...
                            <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-[3rem] p-8 md:p-12 shadow-2xl">
                                ...
                                <div className="mb-8">
                                    ...
                                    <p className="text-slate-400 text-sm mt-3 font-medium">— Handwerksbetrieb, Haan</p>
                                </div>
            ...
            <section className="py-24 px-6 text-center">
                <div className="max-w-3xl mx-auto">
                    ...
                    <p className="text-xl text-slate-500 mb-10 max-w-xl mx-auto leading-relaxed">
                        Lass uns in einem kostenlosen Erstgespräch klären, wie wir deine Online-Präsenz in Haan auf das nächste Level bringen.
                    </p>
